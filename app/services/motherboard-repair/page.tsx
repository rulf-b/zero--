        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="/screens/6.jpeg" alt="Anakart Tamiri" className="w-full h-96 object-cover rounded-2xl shadow-xl mb-4" />
              <img src="/screens/7.jpeg" alt="Anakart Tamiri 2" className="w-40 h-28 object-cover rounded-xl shadow-lg absolute bottom-4 right-4 border-4 border-white" />
            </div>
          </div>
        </div>
      </section>
