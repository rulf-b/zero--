...
const findFilesWithStaticHours = (dir = 'app/markalar') => {
  let results = [];
...
console.log(`Found ${files.length} files to update in markalar directory`);

files.forEach(file => {
  updateFile(file);
});

console.log('Markalar update completed!');
