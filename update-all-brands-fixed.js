...
function createModelDetailPages(brandFolder, brandName, models) {
  ...
  // Model detay sayfası içeriği
  fs.writeFileSync(
    path.join(modelFolderPath, 'page.tsx'),
    createModelPageContent(brandFolder, brandName, models),
    'utf8'
  );
...
function createModelPageContent(brandFolder, brandName, models) {
  return `"use client";
